...
$$ F(q) := \sum_{n=0}^\infty r(n)q^n := \frac{f(-q^3,-q^6)}{\psi(-q)} =  \frac{Q(q^{12},-q^3)}{\psi(-q)} = \frac{(q^3,q^9,q^{12};q^{12})_\infty (q^6,q^{18};q^{24})_\infty}{\psi(-q)}=\frac{(q^3;q^3)_\infty (-q;q^2)_\infty}{ (q^2;q^2)_\infty }  = \frac{(q^{6}; q^{12})_\infty}{(q^{},q^{4},q^{5},q^{7},q^{8},q^{11}; q^{12})_\infty} $$
...
**Notes:**
- McLaughlin and Sills [MS08] (2008, p. 767, Eq. (1.13))
