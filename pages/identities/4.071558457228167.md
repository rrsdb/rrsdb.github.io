...
$ \displaystyle r(n) \sim \frac{\sqrt[4]{3} e^{\frac{1}{2} \sqrt{3} \pi  \sqrt{n}} \sin \left(\frac{\pi}{8}\right)}{8 n^{3/4}} as $ n\to\infty. $
...
**Notes:**
- In Ramanujan's lost notebook, Andrews and Berdnt [AB09] (p. 32, Entry 1.7.6)
- Slater (35), (106)
