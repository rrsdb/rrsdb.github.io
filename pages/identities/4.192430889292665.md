...
$$ F(q) := \sum_{n=0}^\infty r(n)q^n := \frac{f(-q^2,-q^2)}{\varphi(-q)} = \frac{f(q,q^3)}{\psi(-q)} = \frac{Q(q^4,q)}{f(-q)} = \frac{(q^2;q^4)_\infty}{(q,q^3;q^4)_\infty^2} = \frac{(-q;q^2)_\infty}{(q;q^2)_\infty} $$
...
**[Bailey pair](../Bailey_pairs.html) proof:**
> Insert I(7) into the [p-Bailey lemma](../Bailey_pairs.html#p_Bailey_lemma), apply the [triple product identity](../q-series.html#triple_product) and then apply the [quintuple product identity](../q-series.html#quintuple_product).
