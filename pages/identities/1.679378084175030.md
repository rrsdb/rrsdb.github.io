...
$$ F(q) := \sum_{n=0}^\infty r(n)q^n := \frac{Q(q^9,-q)}{f(-q)} = \frac{f(q^3,q^5)}{(q^2;q^2)_\infty} = \frac{1}{(q^{2},q^{3},q^{4},q^{5},q^{11},q^{12},q^{13},q^{14}; q^{16})_\infty} $$
...
**Notes:**
- Due to F. H. Jackson (1928, p. 170, 5th equation)
- Slater (39), (83)
