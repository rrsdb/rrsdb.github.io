...
$$ F(q) := \sum_{n=0}^\infty r(n)q^n := \frac{f(-q,-q^3)}{\varphi(-q)} = \frac{f(1,q^2)}{2\psi(-q)} = \frac{Q(q^{10},-q^4)}{f(-q)} = \frac{1}{(q,q^2,q^3; q^4)_\infty} = 
...
- Slater (11), (51), and (64)
- Unlisted partner to Slater (121) and (123)
